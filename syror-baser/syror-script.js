// ============================================
// QUIZ QUESTIONS - Syror och Baser
// ============================================
const allQuestions = [
    // pH Basics
    {
    ...
    // NEW QUESTIONS - Titrering, buffert och korresponderande par
    {
        question: "Vad är ett korresponderande syra-bas par?",
        options: [
            "Två olika syror",
            "En syra och dess konjugerade bas",
            "Salt och vatten",
            "Två ädelgaser"
        ],
        correct: 1,
        explanation: "Ett korresponderande par är en syra och den bas som bildas när syran avger H⁺."
    },
    {
        question: "Vad är den konjugerade basen till HCl?",
        options: ["H⁺", "Cl⁻", "OH⁻", "NaCl"],
        correct: 1,
        explanation: "När HCl avger H⁺ bildas Cl⁻, som är den konjugerade basen."
    },
    {
        question: "Vad är en amfolyt?",
        options: [
            "Ett ämne som bara är syra",
            "Ett ämne som kan vara både syra och bas",
            "Ett salt",
            "En ädelgas"
        ],
        correct: 1,
        explanation: "Amfolyter, som vatten (H₂O), kan både avge och ta upp protoner."
    },
    {
        question: "Vad är syftet med en titrering?",
        options: [
            "Mäta temperatur",
            "Bestämma okänd koncentration",
            "Skapa salt",
            "Mäta massa"
        ],
        correct: 1,
        explanation: "Vid titrering tillsätter man känd lösning tills ekvivalenspunkten för att bestämma koncentration."
    },
    {
        question: "Vad händer vid ekvivalenspunkten i en titrering?",
        options: [
            "pH = 0",
            "Syra och bas har reagerat i exakt rätt mängd",
            "Lösningen kokar",
            "Inget särskilt"
        ],
        correct: 1,
        explanation: "Vid ekvivalenspunkten har all syra neutraliserats av basen (eller tvärtom)."
    },
    {
        question: "Vad är en buffertlösning?",
        options: [
            "En mycket sur lösning",
            "En lösning som motstår pH-ändringar",
            "Rent vatten",
            "En mättad lösning"
        ],
        correct: 1,
        explanation: "Buffrar innehåller svag syra + konjugerad bas och håller pH stabilt."
    },
    {
        question: "Vilken formel används vid titrering?",
        options: ["pV = nRT", "c₁V₁ = c₂V₂", "n = m/M", "Q = mcΔT"],
        correct: 1,
        explanation: "Vid ekvivalenspunkten gäller c₁V₁ = c₂V₂ för enprotoniga syror och baser."
    },
    {
        question: "Vad är blodets pH ungefär?",
        options: ["6.0", "7.0", "7.4", "8.5"],
        correct: 2,
        explanation: "Blodets pH hålls mycket stabilt runt 7,4 av kolsyra-bikarbonat bufferten."
    }
];
...
function initPhExamples() {
    ...
    container.innerHTML = phExamples.map(ex => {
